    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegisterViewModel", x => x.Name);
                });
            migrationBuilder.CreateTable(
                name: "AspNetRoles",
                columns: table => new
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LevelLevelId = table.Column<int>(nullable: true),
                    TechnologyId = table.Column<string>(nullable: true),
                    TechnologyTechnologyId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Skill", x => x.SkillId);
                    table.ForeignKey(
                        name: "FK_Skill_Level_LevelLevelId",
                        column: x => x.LevelLevelId,
                        principalTable: "Level",
                        principalColumn: "LevelId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Skill_Technology_TechnologyTechnologyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillSkillId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicationUser_Skill_SkillSkillId",
                        column: x => x.SkillSkillId,
        ...
        {
            migrationBuilder.DropTable("RegisterViewModel");
